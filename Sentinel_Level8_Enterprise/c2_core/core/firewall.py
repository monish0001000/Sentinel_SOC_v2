...
class FirewallService:
    ...
    def match_traffic(self, ip: str, port: int, country: str = None, pid: int = None) -> str:
        """
        Master evaluation logic. Uses Default Pass routing.
        Returns: 'allow' or 'deny'
        """
        # Loopback/private bypass — never block
        _bypass = ("127.", "::1", "0.0.0.0")
        _private = ("192.168.", "10.", "172.16.", "172.17.", "172.18.",
                     "172.19.", "172.20.", "172.21.", "172.22.", "172.23.",
                     "172.24.", "172.25.", "172.26.", "172.27.", "172.28.",
                     "172.29.", "172.30.", "172.31.")
        
        if ip.startswith(_bypass) or ip in self.whitelist_ips:
            return "allow"
        ...
        # 4. Explicit Block Lists
        if ip in self.blocked_ips:
            return "deny"
        if port in self.blocked_ports:
            return "deny"

        # 5. Default Pass — allow everything else
        return "allow"
